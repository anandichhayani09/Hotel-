                            ...
                            <div class="row">
                                <table class="table table-bordered table-hover" style="text-align: center">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    <td data-column="name"> <?php echo $row['firstname']; ?></td>
                                                    <td data-column="email"> <?php echo $row['email']; ?></td>
                                                    <td data-column="mobileno"><?php echo $row['mobileno']; ?></td>
                                                    <td data-column="country"><?php echo $row['country']; ?></td>
                                                    <td data-column="tootal_room"><?php echo $row['total_room']; ?></td>
                                                    <td data-column="checkin"><?php echo $row['checkin']; ?></td>
                                                    <td data-column="checkout"><?php echo $row['checkout']; ?></td>
                                                    <td data-column="total_price"><?php echo $row['total_price']; ?></td>
                                                    <td data-column="payment"><?php echo $row['payment']; ?></td>
