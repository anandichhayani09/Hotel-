                        ...
                        <div class="classynav">
                            ...
                            <?php
                                  include 'connection.php'; // Ensure connection to the database
                                   ...
                                   $qry = $con->query("SELECT * FROM categories");
                                   ...
                                   while($row = $qry->fetch_assoc()) {
                                    $categoryId = intval($row['id']); // Sanitize category ID
                                    $categoryName = htmlspecialchars($row['category_nm']); // Sanitize category name
                                
                                    // Adjust the file name as needed
                                    // $roomFile = 'room'  . '.php'; // Dynamically set the file based on category ID
                                
                                    // echo '<li><a href="./' . $roomFile . '?category=' . $categoryId . '">- ' . $categoryName . '</a></li>';
                                
                                   echo '<li><a href="./room1.php?category=' . $row['id'] . '">- ' . htmlspecialchars($row['category_nm']) . '</a></li>';
